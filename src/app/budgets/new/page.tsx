   ...
   <main className="container mx-auto px-4 py-8">
    <div className="max-w-2xl mx-auto">
     <div className="mb-8">
      ...
      <p className="text-slate-400 mt-2">Defina limites de gastos para controlar suas finanças</p>
     </div>

     <BudgetForm categories={categories} action={createBudget} title="Criar Novo Orçamento" />
    </div>
   </main>
  </div>
 )
